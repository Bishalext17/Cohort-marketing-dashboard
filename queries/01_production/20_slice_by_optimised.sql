...
-- slice_2 accepts: date | campaign | ad | country | none   <- must have a value
-- Defaults: slice_1 = campaign, slice_2 = none, both "Always require a value" ON
-- PASTE CHECK: last line ends  ORDER BY spend DESC, slice_1;  and file contains att_pct
